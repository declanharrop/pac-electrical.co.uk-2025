...
export default function SimpleHeaderTextBlock({
  ...
  content = {
    ...
    text: [
      'Power and Control is committed to providing innovative and high-quality solutions that empower our clients to optimise their energy usage. We specialise in the design and installation of renewable energy systems, EV charging infrastructure, and energy-efficient electrical installations for residential and commercial properties.',
