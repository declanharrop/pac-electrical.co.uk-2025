...
export default function ElecView5() {
    ...
    <>
      ...
      <div className={Styles.Solar__GAQ__View10__Container}>
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Google' }, '/get-a-quote/electrical/4')
          }
        >
          <img
        ...
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Facebook' }, '/get-a-quote/electrical/4')
          }
        >
          <img
            className={Styles.GetAQuotePage__Button_Icon_P10}
        ...
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Vans' }, '/get-a-quote/electrical/4')
          }
        >
          <img
            className={Styles.GetAQuotePage__Button_Icon_P10}
        ...
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Flyer' }, '/get-a-quote/electrical/4')
          }
        >
          <img
            className={Styles.GetAQuotePage__Button_Icon_P10}
        ...
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Other' }, '/get-a-quote/electrical/4')
          }
        >
          <img
            className={Styles.GetAQuotePage__Button_Icon_P10}
