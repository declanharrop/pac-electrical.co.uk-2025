...
export default function SolarComView10() {
    ...
    <>
      ...
      <div className={Styles.Solar__GAQ__View10__Container}>
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Google' }, '/get-a-quote/solar/com/9')
          }
        >
          <img
        ...
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Linked In' }, '/get-a-quote/solar/com/9')
          }
        >
          <img
            className={Styles.GetAQuotePage__Button_Icon_P10}
        ...
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Facebook' }, '/get-a-quote/solar/com/9')
          }
        >
          <img
            className={Styles.GetAQuotePage__Button_Icon_P10}
        ...
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Instagram' }, '/get-a-quote/solar/com/9')
          }
        >
          <img
            className={Styles.GetAQuotePage__Button_Icon_P10}
        ...
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Vans' }, '/get-a-quote/solar/com/9')
          }
        >
          <img
            className={Styles.GetAQuotePage__Button_Icon_P10}
        ...
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Flyer' }, '/get-a-quote/solar/com/9')
          }
        >
          <img
            className={Styles.GetAQuotePage__Button_Icon_P10}
        ...
        <button
          ...
          type="button"
          onClick={() =>
            chooseOption({ heardFrom: 'Other' }, '/get-a-quote/solar/com/9')
          }
        >
          <img
            className={Styles.GetAQuotePage__Button_Icon_P10}
