// src/ComponentsV2/ContentBlocks/Navigation/Header.js
      ...
      <div className={styles.container}>
        ...
        <div className={styles.rightActions}>
          <div className={styles.staticIcons}>
            {/* Group 1: Brand Social Ecosystem (Hidden on Mobile) */}
            ...
            <div className={`${styles.divider} ${styles.hideMobileDivider}`} />

            {/* Group 2: Live Action Conversions (Retained Across Layouts) */}
