...
// We removed the import Link because the parent (LandingHero) now wraps this in a Link.

export default function GetAQuoteButton({ Title = 'Get a quote' }) {
  return (
    <div>
      {/* We keep motion.button exactly as you had it. 
        Since this is now wrapped in a Link in the parent component, 
        clicking this button triggers that Link.
      */}
      <motion.button
        type="button"
